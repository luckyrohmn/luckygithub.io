...
profiles:
  ...
  - icon: brands/github
    url: https://github.com/luckyrohmn/luckygithub.io
...
awards:
  ...
  - title: 'Machine learning & AI for Beginner'
    ...
    certificate_url: https://drive.google.com/file/d/1KdNW-AIzxsJwODyxrbJiDcj3hUYhOZ4e/view?usp=sharing
    date: '2024-11-01'
    awarder: DQLAB
    icon: datacamp
    summary: |
      Learned:
      - Understand the basics of Machine Learning & AI, develop environments using Python and Colab, and perform basic Python exercises.
      - Prepare and clean data for analysis using Python libraries.
      - Understand the importance of data visualization in Machine Learning & AI, be able to create visualizations using Python libraries, and be able to perform EDA.
---
